...
object Dependencies {
    ...
    object Avito {
        const val proxyToast = "com.avito.android:proxy-toast"
        const val testInhouseRunner = "com.avito.android:test-inhouse-runner"
        const val testReport = "com.avito.android:test-report"
        const val junitUtils = "com.avito.android:junit-utils"
        const val toastRule = "com.avito.android:toast-rule"
        const val testAnnotations = "com.avito.android:test-annotations"
        const val uiTestingCore = "com.avito.android:ui-testing-core"
        const val reportViewer = "com.avito.android:report-viewer"
        const val fileStorage = "com.avito.android:file-storage"
        const val okhttp = "com.avito.android:okhttp"
        const val time = "com.avito.android:time"
    }
